                    ...
                    <form method="POST" action="{{ route('guests.update', $guest->id) }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="designation" id="designation" value="{{ old('designation', $guest->designation) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="company" id="company" value="{{ old('company', $guest->company) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="category" id="category" value="{{ old('category', $guest->category) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="proposalBy" id="proposalBy" value="{{ old('proposalBy', $guest->proposalBy) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="guestOf" id="guestOf" value="{{ old('guestOf', $guest->guestOf) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="RSVP" id="RSVP" value="{{ old('RSVP', $guest->RSVP) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="tableAllocation" id="tableAllocation" value="{{ old('tableAllocation', $guest->tableAllocation) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="attendance" id="attendance" value="{{ old('attendance', $guest->attendance) }}"
