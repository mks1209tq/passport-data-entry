...
{
    protected $signature = 'leaves:assign-one {count : Number of leaves to assign per user} {users* : Array of user IDs}';

    protected $description = 'Assign unassigned leaves to particular user';
